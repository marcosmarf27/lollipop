...
class CustomerDataGridView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $col_name    = new TDataGridColumn('name', 'Nome', 'left', '28%');
        $col_address = new TDataGridColumn('address', 'Endereço', 'left', '28%');
        $col_city    = new TDataGridColumn('{city->name} ({city->state->name})', 'Cidade', 'left', '28%');
        $col_gender  = new TDataGridColumn('gender', 'Gênero', 'left', '6%');
        ...
        $dropdown->addAction( 'Salvar as CSV', new TAction([$this, 'onExportCSV'], ['register_state' => 'false', 'static'=>'1']), 'fa:table fa-fw blue' );
        $dropdown->addAction( 'Salvar as PDF', new TAction([$this, 'onExportPDF'], ['register_state' => 'false', 'static'=>'1']), 'far:file-pdf fa-fw red' );
        $dropdown->addAction( 'Salvar as XML', new TAction([$this, 'onExportXML'], ['register_state' => 'false', 'static'=>'1']), 'fa:code fa-fw green' );
        $panel->addHeaderWidget( $dropdown );
        
        $panel->addHeaderActionLink( 'Novo Cliente',  new TAction(['CustomerFormView', 'onEdit'], ['register_state' => 'false']), 'fa:plus green' );
